 ...
 */
@Endpoint // register the class with Spring WS
public class RegionEndpoint {
    ...
    @PayloadRoot(namespace = NAMESPACE_URI, localPart = "getRegionRequest")
    @ResponsePayload    // response will be placed in response payload (body)
